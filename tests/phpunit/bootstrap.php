...
// Enable test mode so Client::compose() returns a deterministic dummy response
// without making real AI API calls. Tests that verify the compose path rely on
// this; tests that verify permissions or catalog logic are unaffected.
if ( ! defined( 'KRATT_TEST_MODE' ) ) {
...
tests_add_filter(
	'muplugins_loaded',
	static function () {
		require_once dirname( __DIR__, 2 ) . '/kratt.php';
	}
);
